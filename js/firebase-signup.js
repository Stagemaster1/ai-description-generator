// Firebase Signup Module - Extracted for CSP Compliance
// Specialized Firebase initialization for signup page with additional auth functions

import { initializeApp } from 'https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js';
import { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendEmailVerification, sendPasswordResetEmail, onAuthStateChanged, onIdTokenChanged } from 'https://www.gstatic.com/firebasejs/10.12.2/firebase-auth.js';
...
async function initializeFirebaseSecure() {
    try {
        ...
        console.log('Firebase initialized securely for signup page');
