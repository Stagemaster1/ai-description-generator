...
const translations = {
  en: {
    ...
    agreementText: 'I agree to the Terms of Service and GDPR Policy',
  ...
  es: {
    ...
    agreementText: 'Acepto los Términos de Servicio y la Política GDPR',
  ...
  de: {
    ...
    agreementText: 'Ich stimme den Nutzungsbedingungen und der DSGVO-Richtlinie zu',
  ...
  fr: {
    ...
    agreementText: 'J\'accepte les Conditions d\'Utilisation et la Politique RGPD',
  ...
  it: {
    ...
    agreementText: 'Accetto i Termini di Servizio e la Politica GDPR',
  ...
  'pt-BR': {
    ...
    agreementText: 'Aceito os Termos de Serviço e a Política GDPR',
